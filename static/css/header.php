...
<!--[if lt IE 9]><script src="<?php echo get_template_directory_uri(); ?>/js/vendor/html5shiv.min.js"></script><![endif]-->
...
<body <?php body_class(); ?> itemscope itemtype="http://schema.org/WebPage">
	<header id="header" role="banner" itemscope itemtype="http://schema.org/WPHeader">
		...
		<div class="connect">
			...
			<?php if (get_option('minty_rss_url') != '') : ?><a target="_blank" href="<?php echo get_option('minty_rss_url'); ?>" class="rss" title="RSS"><span>RSS</span></a><?php endif; ?>
			<?php get_search_form(); ?>
		</div>
		...
		<div id="m-btns">
			<div class="menu" title="菜单">
				...
				$mNav = strip_tags( wp_nav_menu( array(
					...
					'container'       => false,
					'menu_id'         => 'm-menu',
					'items_wrap'      => '<select id="%1$s" onchange="location.href=this.value"><option disabled selected>导航菜单</option>%3$s</select>',
					'depth'           => 2,
					'echo'            => false
				) ), '<select><option><optgroup><a><ul>' );
